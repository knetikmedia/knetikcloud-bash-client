...
# Setup prompt
#
RUN echo 'export PS1="[Knetik Platform API Documentation latest] \$ "' >> ~/.bashrc
RUN echo 'export PROMPT="[Knetik Platform API Documentation latest] \$ "' >> ~/.zshrc
...
line REST client for $(tput setaf 6)Knetik Platform API Documentation latest$(tput sgr0).\n\
\n\
