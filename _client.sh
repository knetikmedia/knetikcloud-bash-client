...
case $state in
  ops)
    ...
    _values "Operations" \
            ...
            "updateActivityOccurrence[Updated the status of an activity occurrence]"             "getSignedS3URL[Get a signed S3 URL]"             "createClient[Create a new client]" \
            ...
            "updateAchievementProgress[Update or create an achievement progress record for a user]" \
            ...
            "updateLevel[Update a level]" \
            "updateUserLevel[Update or create a leveling progress record for a user]"             "addMetric[Add a metric]"             "addQuestionAnswers[Add an answer to a question]" \
            ...
            "searchIndex[Search an index]"             "createItemTemplate[Create an item template]" \
            ...
            "updateStateTax[Create or update a state tax]"             "addUserTag[Add a tag to a user]" \
...
"filter_shipping=:[QUERY] Filters invoices by shipping price"
...
"user_id=:[PATH] The user id of the member to modify"
      ...
      updateGroups)
        local -a _op_arguments
        _op_arguments=(
                    "filter_name=:[QUERY] Filter for groups whose name starts with provided string"
"filter_unique_name=:[QUERY] Filter for groups whose unique_name starts with provided string"
"filter_parent=:[QUERY] Filter for groups whose parent equals provided string"
"size=:[QUERY] The number of objects returned per page"
"page=:[QUERY] The number of the page returned, starting with 1"
"order=:[QUERY] A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]"
          )
