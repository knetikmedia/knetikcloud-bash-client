...
case $state in
  ops)
    ...
    _values "Operations" \
            ...
            "getActivityOccurrenceDetails[Load a single activity occurrence details]" \
            ...
            "updateCurrency[Update a currency]"             "addDeviceUsers[Add device users]" \
            "createDevice[Create a device]" \
            "createDeviceTemplate[Create a device template]" \
            "deleteDevice[Delete a device]" \
            "deleteDeviceTemplate[Delete an device template]" \
            "deleteDeviceUser[Delete a device user]" \
            "deleteDeviceUsers[Delete all device users]" \
            "getDevice[Get a single device]" \
            "getDeviceTemplate[Get a single device template]" \
            "getDeviceTemplates[List and search device templates]" \
            "getDevices[List and search devices]" \
            "updateDevice[Update a device]" \
            "updateDeviceTemplate[Update an device template]"             "addDisposition[Add a new disposition]" \
            ...
            "updateArtistTemplate[Update an artist template]"             "addFlag[Add a flag]" \
            ...
            "getObjectItem[Get a single object]" \
            "getObjectItems[List and search objects]" \
            "getObjectTemplate[Get a single entitlement template]" \
            "getObjectTemplates[List and search entitlement templates]" \
            "updateObjectItem[Update an object]" \
            "updateObjectTemplate[Update an entitlement template]"             "createPaymentMethod[Create a new payment method for a user]" \
            "deletePaymentMethod[Delete an existing payment method for a user]" \
            "getPaymentMethod[Get a single payment method for a user]" \
            "getPaymentMethodType[Get a single payment method type]" \
            "getPaymentMethodTypes[Get all payment method types]" \
            ...
            "updateWalletBalance[Updates the balance for a user's wallet]"             "createXsollaTokenUrl[Create a payment token that should be used to forward the user to Xsolla so they can complete payment]"             "getChallengeEventLeaderboard[Retrieve a challenge event leaderboard details]" \
            ...
            "getCouponItemBySku[Get a coupon by sku]" \
            ...
            "submitPasswordReset[Reset a user's password without user id]" \
            ...
            "addMembersToGroup[Adds multiple members to the group]" \
            ...
            "updateGroupMemberProperties1[Change a user's membership properties]" \
            "updateGroupMemberStatus[Change a user's status]" \
            "updateGroupMemberTemplate[Update an group member template]" \
            "updateGroupTemplate[Update a group template]"             "addItemToUserInventory[Adds an item to the user inventory]" \
...
"order=:[QUERY] A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]"
      ...
      deleteTokens)
        local -a _op_arguments
        _op_arguments=(
                    "username=:[QUERY] The username of the user"
...
"page=:[QUERY] The number of the page returned, starting with 1"
      ...
      getCampaignChallenges)
        ...
        _op_arguments=(
          "id=:[PATH] The campaign id"
          "filter_start_date=:[QUERY] A comma separated string without spaces.  First value is the operator to search on, second value is the challenge start date, a unix timestamp in seconds.  Allowed operators: (GT, LT, EQ, GOE, LOE)."
"filter_end_date=:[QUERY] A comma separated string without spaces.  First value is the operator to search on, second value is the challenge end date, a unix timestamp in seconds.  Allowed operators: (GT, LT, EQ, GOE, LOE)."
"size=:[QUERY] The number of objects returned per page"
"page=:[QUERY] The number of the page returned, starting with 1"
"order=:[QUERY] A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]"
          )
...
"user_id=:[PATH] The user id of the device user"
                    )
        _describe -t actions 'operations' _op_arguments -S '' && ret=0
        ;;
      deleteDeviceUsers)
        ...
        _op_arguments=(
          "id=:[PATH] The id of the device"
          "filter_id=:[QUERY] Filter for device users to delete with a user id in a given comma separated list of ids"
          )
        _describe -t actions 'operations' _op_arguments -S '' && ret=0
        ;;
      getDevice)
...
"filter_os=:[QUERY] Filter for devices with specified OS"
"filter_serial=:[QUERY] Filter for devices with specified serial"
"filter_type=:[QUERY] Filter for devices with specified type"
"filter_tag=:[QUERY] A comma separated list without spaces to filter for devices with specified tags (matches any)"
"size=:[QUERY] The number of objects returned per page"
"page=:[QUERY] The number of the page returned, starting with 1"
"order=:[QUERY] A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]"
          )
...
"filter_event_id=:[QUERY] Filter event logs by request id"
"size=:[QUERY] The number of objects returned per page"
"page=:[QUERY] The number of the page returned, starting with 1"
"order=:[QUERY] A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]"
          )
...
"order=:[QUERY] A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]"
      ...
      deleteFlag)
        local -a _op_arguments
        _op_arguments=(
                    "context_name=:[QUERY] The name of the context"
"context_id=:[QUERY] The id of the context"
"user_id=:[QUERY] The id of the user"
      ...
      getFlags)
        local -a _op_arguments
        _op_arguments=(
                    "filter_context=:[QUERY] Filter by flag context"
"filter_context_id=:[QUERY] Filter by flag context ID"
"filter_user_id=:[QUERY] Filter by user ID"
"size=:[QUERY] The number of objects returned per page"
"page=:[QUERY] The number of the page returned, starting with 1"
          )
        _describe -t actions 'operations' _op_arguments -S '' && ret=0
...
"relationship_id=:[PATH] The relationship id"
      ...
      createObjectItem)
        local -a _op_arguments
        _op_arguments=(
          "template_id=:[PATH] The id of the template this object is to be part of"
...
"object_id=:[PATH] The id of the object"
      ...
      getObjectItems)
        local -a _op_arguments
        _op_arguments=(
          "template_id=:[PATH] The id of the template to get objects for"
          "size=:[QUERY] The number of objects returned per page"
"page=:[QUERY] The number of the page returned, starting with 1"
"order=:[QUERY] A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]"
          )
...
"id=:[PATH] ID of the payment method being retrieved"
      ...
      getPaymentMethodType)
        local -a _op_arguments
        _op_arguments=(
          "id=:[PATH] ID of the payment method type being retrieved"
                    )
        _describe -t actions 'operations' _op_arguments -S '' && ret=0
        ;;
      getPaymentMethodTypes)
        local -a _op_arguments
        _op_arguments=(
                    "filter_name=:[QUERY] Filter for payment method types whose name matches a given string"
"size=:[QUERY] The number of objects returned per page"
"page=:[QUERY] The number of the page returned, starting with 1"
"order=:[QUERY] a comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]"
          )
...
"filter_last_activity=:[QUERY] A comma separated string without spaces.  First value is the operator to search on, second value is the date, a unix timestamp in seconds.  Allowed operators: (GT, LT, EQ, GOE, LOE)."
"filter_id_list=:[QUERY] A comma separated list of ids."
...
"id=:[PATH] The id of the user to befriend"
      ...
      getFriends)
        ...
        _op_arguments=(
          "user_id=:[PATH] The id of the user or &#39;me&#39;"
          "filter_username=:[QUERY] Filter for friends with the given username"
"filter_user_id=:[QUERY] Filter for friends by user id"
"size=:[QUERY] The number of objects returned per page"
"page=:[QUERY] The number of the page returned, starting with 1"
          )
        _describe -t actions 'operations' _op_arguments -S '' && ret=0
...
"order=:[QUERY] a comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]"
      ...
      getGroupsForUser)
        ...
        _op_arguments=(
          "user_id=:[PATH] The id of the user"
          "filter_children=true:[QUERY] Whether to limit group list to children of groups only. If true, shows only groups with parents. If false, shows only groups with no parent."
          "filter_children=false:[QUERY] Whether to limit group list to children of groups only. If true, shows only groups with parents. If false, shows only groups with no parent."
          )
        _describe -t actions 'operations' _op_arguments -S '' && ret=0
        ;;
      listGroups)
...
"item_id=:[PATH] The id of the item"
      ...
      getEntitlementItems)
        local -a _op_arguments
        _op_arguments=(
                    "filter_template=:[QUERY] Filter for entitlements using a specified template"
"size=:[QUERY] The number of objects returned per page"
"page=:[QUERY] The number of the page returned, starting with 1"
"order=:[QUERY] A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]"
          )
